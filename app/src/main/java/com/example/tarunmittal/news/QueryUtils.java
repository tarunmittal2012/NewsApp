...
public class QueryUtils {
    ...
    private static final String KEY_IMAGE = "bylineImageUrl";
    ...
    private static String image = "https://static.guim.co.uk/sys-images/Guardian/Pix/pictures/2010/3/18/1268912780816/Dave-Gelly.jpg";
    ...
    private static List<News> extractFeatureFromJson(String jsonResponse) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                String[] seprate = webPublicationDate.split("T");
                String date = seprate[0];
                String time[] = seprate[1].split("Z");
                String time1 = time[0];
                ...
                JSONArray tagArray = currentNews.getJSONArray(KEY_TAG);
                ...
                News mNews = new News(webTitle, "Date:" + date + " " + "Time:" + time1, webUrl, author, sectionName, authorImage);
                news.add(mNews);

            }
        } catch (JSONException e) {
            Log.e(LOG_TAG, "Json not found", e);
            e.printStackTrace();
